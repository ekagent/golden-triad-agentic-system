import { getLaneCatalog, getProviderStatus } from "@/lib/catalog";
...
function directProviderPriority(providerId, providerMode) {
  ...
  if (providerMode === "memo-first") {
    return providerId === "memo" ? 5 : 2;
  }
...
export function buildGoldenRulePlan(task, providerMode = "auto", objective = "golden") {
