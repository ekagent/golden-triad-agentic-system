...
function buildAuthHelp(runtime) {
  if (runtime.id === "openrouter") {
    return "Update OPENROUTER_API_KEY or your saved OpenRouter key in Dashboard > Settings.";
  }
  ...
  if (runtime.id === "memo") {
    return "Update MEMO_API_KEY / MIMO_API_KEY or your saved Memo key in Dashboard > Settings.";
  }
