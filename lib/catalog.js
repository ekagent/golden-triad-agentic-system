...
export function getProviderStatus() {
  const glm = getIntegrationConfig("glm");
  const memo = getIntegrationConfig("memo");
  const openrouter = getIntegrationConfig("openrouter");
  ...
  return {
    ...
    minimax: {
      id: "minimax",
      label: "Minimax",
      configured: getIntegrationConfig("minimax").configured,
      baseUrl: getIntegrationConfig("minimax").baseUrl,
      mode: "direct provider"
    },
    github: {
      id: "github",
      label: "GitHub",
      configured: getIntegrationConfig("github").configured,
      baseUrl: getIntegrationConfig("github").baseUrl,
      mode: "direct provider"
    }
  };
}
...
export function getProviderRuntime(providerId) {
  if (providerId === "glm") {
    const integration = getIntegrationConfig("glm");
    return {
      id: integration.id,
  ...
  if (providerId === "memo") {
    const integration = getIntegrationConfig("memo");
    return {
      id: integration.id,
      label: integration.label,
      configured: integration.configured,
  ...
  if (providerId === "minimax") {
    const integration = getIntegrationConfig("minimax");
    return {
      id: integration.id,
      label: integration.label,
      configured: integration.configured,
  ...
  if (providerId === "github") {
    const integration = getIntegrationConfig("github");
    return {
      id: integration.id,
      label: integration.label,
      configured: integration.configured,
  ...
  const integration = getIntegrationConfig("openrouter");
  return {
    id: integration.id,
    label: integration.label,
    configured: integration.configured,
...
export function getSafeCatalog() {
